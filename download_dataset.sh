...
find nutrition-lc-fr-country-fr-last-edit-date-2019-08/ -name '*.nutrition.jpg' -exec mv {} image_files/ \;
find nutrition-lc-fr-country-fr-last-edit-date-2019-08/ -name '*.nutrition.cropped.jpg' -exec mv {} cropped_images/ \;
find nutrition-lc-fr-country-fr-last-edit-date-2019-08/ -name '*.nutriments.json' -exec mv {} json_files/ \;
find nutrition-lc-fr-country-fr-last-edit-date-2019-08/ -name '*.nutrition.cropped.json' -exec mv {} cropped_json_files/ \;
